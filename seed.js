...
import { Friendship } from "../src/common/models/friendshipModel.js";
import JoinRequest from "../src/common/models/joinRequestModel.js";
...
import AssignmentSubmission from "../src/modules/assignment/models/assignmentSubmissionModel.js";
import AlertnessSession from "../src/modules/alertness/models/alertnessSessionModel.js";
import QuickLesson from "../src/modules/quickLesson/models/quickLessonModel.js";
import Notification from "../src/modules/notification/models/notificationModel.js";
import Report from "../src/modules/report/models/reportModel.js";
...
/**
 * Auto-initialize database on backend startup
 * This function is called automatically when the backend starts
 */
export const autoInitializeDatabase = async () => {
  try {
    ...
    console.log("📭 No users found - Auto-initializing database with seed data...\n");
    ...
    console.log("📊 Summary: Created sample data including users, conversations, messages, and more");
    console.log("🔐 Default login: superadmin@chatapp.com / Admin@123!\n");
  } catch (error) {
...
// Run the seed script only when called directly
