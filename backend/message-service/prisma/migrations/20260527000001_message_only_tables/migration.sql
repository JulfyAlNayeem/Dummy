-- Message-service exclusive tables
-- (users, conversations, conversation_participants, messages, message_media
--  are already owned by api-service; we only create what is missing here)
